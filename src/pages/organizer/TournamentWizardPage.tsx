      ...
      <div className="rounded-card border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
        ...
        {step === 6 && (
          <div className="space-y-4">
            ...
            <TextField label="Tournament URL slug" value={form.subdomain} onChange={(v) => update("subdomain", slugify(v))} />
            <p className="text-xs text-[var(--color-muted)]">
              Your public website will be: <strong>{getTournamentUrl(form.subdomain || "your-slug")}</strong>. Custom
        ...
        {step === 7 && (
          <div className="space-y-3 text-sm">
            ...
            <ReviewRow label="Public URL" value={form.subdomain ? getTournamentUrl(form.subdomain) : "—"} />
